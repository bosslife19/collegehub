...
import errored from "../assets/404.png"
const PageNotFound = () => {
    return (

            <div className="flex flex-col px-3 lg:px-16 gap-3  border-gray h-full justify-center items-center mt-[50px]">
                <div className="">
                    <img

                        src={errored}

                    className="md:w-[400px] w-[200px] rounded-[10px]"
                        alt="notfound"
