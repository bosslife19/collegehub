    ...
    <div className=" bg-[#F4E2EF] w-full flex-wrap ">
      <div className="py-[20px] md:py-[50px] md:flex flex-wrap justify-between px-[40px]  items-center">
        <form className=" py-[20px] px-[14px] bg-[#fff]  rounded-[10px] md:w-[500px] ">
           ...
           <button onClick={handleLogin} className="px-[10px] w-full md:px-[12%] rounded-[6px] md:rounded-lg font-inter leading-[15px] md:leading-[29.0px] text-[13px] md:text-[20px] bg-[#91447B] text-[#fff] font-[400] py-[10px] border">
           {buttonSpinner ? (
            ...
            Don’t have an account? <Link to="/dashboard" onClick={toggleForm} className="text-[#91447B] font-[600]">SignUp</Link>
            </span>
           </div>
